...
class SongRequestScriptLogHandler(logging.Handler):
    ...
    def __init__(self, parent_wrapper, settings, log_level=None):
        super(SongRequestScriptLogHandler, self).__init__()
    ...
    def _setup_logging(self, log_level):
        ...
        formatter = SongRequestLoggerFactory.create_formatter()
...
class SongRequestFileLogWrapper(object):
    ...
    def _enable_logging(self, log_level):
        ...
        file_log_handler = SongRequestLoggerFactory.create_file_log_handler(
            log_level
        )
...
class SongRequestLogWrapper(object):
    """
    ...
    def _setup_script_logging(self, log_level):
        self._script_log_handler = SongRequestScriptLogHandler(
    ...
    def _setup_file_logging(self, log_level):
        ...
        self._file_log_handler_wrapper = SongRequestFileLogWrapper(
            self._settings, self._logger, log_level
        )


class SongRequestLoggerFactory(object):
    ...
    def init_logging(cls, parent_wrapper, settings):
        ...
        Initializes logging.
        """
        wrapper = SongRequestLogWrapper(parent_wrapper, settings)
