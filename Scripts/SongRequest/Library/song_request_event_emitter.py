...
class SongRequestEventEmitter(object):
    """
    ...
    def on(self, event, func=None, ttl=-1):
        ...
        def _on(func):
            ...
            listener = SongRequestListener(func, event, ttl)
    ...
    def on_any(self, func=None, ttl=-1):
        ...
        def _on_any(func):
            ...
            listener = SongRequestListener(func, None, ttl)
            listeners.append(listener)
...
class SongRequestListener(object):
    """
    The Listener class.
