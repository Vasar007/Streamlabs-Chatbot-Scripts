...
class TransferScriptLogHandler(logging.Handler):
    ...
    def _setup_logging(self, log_level):
        ...
        formatter = TransferLoggerFactory.create_formatter()
...
class TransferFileLogWrapper(object):
    ...
    def _enable_logging(self, log_level):
        ...
        file_log_handler = TransferLoggerFactory.create_file_log_handler(
            log_level
        )
...
class TransferLogWrapper(object):
    ...
    def _setup_script_logging(self, log_level):
        self._script_log_handler = TransferScriptLogHandler(
    ...
    def _setup_file_logging(self, log_level):
        ...
        self._file_log_handler_wrapper = TransferFileLogWrapper(
